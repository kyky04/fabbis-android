...
public class MainPelatihActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_pelatih);
    ...
    public void onViewClicked(View view) {
        Intent intent = new Intent(MainPelatihActivity.this, MenuDetailActivity.class);
        switch (view.getId()) {
