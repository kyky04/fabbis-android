...
public class PosisiTerbaikActivity extends AppCompatActivity {
    ...
    public void onViewClicked(View view) {
        Intent intent = new Intent(PosisiTerbaikActivity.this, PemainTerbaikActivity.class);
        ...
        switch (view.getId()) {
            ...
            case R.id.fab_add:
                ...
                ActivityUtils.addFragment(PosisiTerbaikActivity.this, android.R.id.content, fragment);
