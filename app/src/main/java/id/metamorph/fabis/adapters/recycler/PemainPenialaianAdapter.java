...
public class PemainPenialaianAdapter extends RecyclerView.Adapter<PemainPenialaianAdapter.MyHolder> {
    Context context;
    ...
    public PemainPenialaianAdapter(Context context, List<DataItemPemain> listArticle) {
        this.context = context;
        this.listItem = listArticle;
    }

    public PemainPenialaianAdapter(Context context) {
        this.context = context;
        this.listItem = new ArrayList<>();
    }
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_pemain_penilaian, parent, false);
